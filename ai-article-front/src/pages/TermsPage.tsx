...
const sections = [
  {
    title: "제1조 (목적)",
    content: [
      "본 약관은 AHAread(이하 \"서비스\")가 제공하는 AI 기반 뉴스 기사 분석 서비스의 이용과 관련하여 서비스와 이용자 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.",
    ],
  },
  {
    title: "제2조 (서비스의 내용)",
    content: [
      "AHAread는 다음과 같은 서비스를 제공합니다.",
  ...
  },
  {
    title: "제5조 (지적재산권)",
    content: [
      "• 서비스가 제공하는 AI 분석 결과, UI 디자인, 소프트웨어 등에 대한 지적재산권은 AHAread에 귀속됩니다.",
      "• 수집된 뉴스 기사의 저작권은 해당 언론사에 귀속되며, AHAread는 공정 이용 범위 내에서 요약 및 분석 목적으로만 활용합니다.",
  ...
  },
  {
    ...
    content: [
      "• AHAread는 서비스의 내용을 변경하거나 중단할 수 있으며, 이 경우 사전에 공지합니다.",
  ...
  },
  {
    ...
    content: [
      ...
      "• 이용자가 서비스를 통해 얻은 정보를 활용하여 발생한 손해에 대해 AHAread는 책임을 지지 않습니다.",
