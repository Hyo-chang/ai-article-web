...
const sections = [
  {
    ...
    content: [
      "AI Reader는 서비스 제공을 위해 아래와 같은 개인정보를 수집합니다.",
  ...
  },
  {
    ...
    content: [
      "AI Reader는 원칙적으로 이용자의 개인정보를 제3자에게 제공하지 않습니다.",
      "다만, 아래의 경우에는 예외로 합니다.",
      "• 이용자가 사전에 동의한 경우",
      "• 법령에 의해 요구되는 경우",
    ],
  },
  {
    ...
    content: [
      "AI Reader는 로그인 상태 유지 및 사용자 환경 설정(다크 모드 등)을 위해 쿠키 및 로컬 스토리지를 사용합니다.",
