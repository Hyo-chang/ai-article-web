...
출력:"""
    ...
    def summarize_and_define(self):
        ...
        [기사 원문 전체]의 핵심 내용을 3개 항목으로 요약해 주십시오.

        **중요한 규칙:**
        - 각 항목의 제목은 "핵심 주제를 설명하는 짧은 문구"로 작성하세요.
        - 제목 뒤에는 1문장으로 간결하게 요약하세요.
        - 제목은 단순 키워드가 아니라, 무슨 일이 있었는지 알 수 있는 문구여야 합니다.

        **출력 형식 (반드시 준수):**
        1. **[주제를 설명하는 제목]**: 한 문장 요약.
        2. **[주제를 설명하는 제목]**: 한 문장 요약.
        3. **[주제를 설명하는 제목]**: 한 문장 요약.

        **올바른 예시:**
        1. **[충주맨의 사직 발표]**: 충주시 유튜브 채널의 김선태 주무관이 공직 생활을 마감하고 사직을 발표했습니다.
        2. **[사직 후 구독자 급감]**: 나흘 만에 약 16만 7000명의 구독자가 이탈하며 80만 명 선이 위협받고 있습니다.
        3. **[지자체 홍보 혁신의 끝]**: B급 감성으로 전국 지자체 중 최다 구독자를 확보했던 채널이 위기에 직면했습니다.

        **잘못된 예시 (이렇게 하면 안 됩니다):**
        1. **[충주맨]**: 충주시 유튜브 채널의 주요 콘텐츠 제작자로 활동하며... (제목이 단순 키워드)
        2. **[구독자수]**: 김선태 주무관의 사직 발표 이후... (제목이 단순 키워드)
